angular
    .module('altairApp')
    .controller('dashboarddetailsViewController', [
        '$scope',
        '$rootScope',
        'utils',
        function ($scope,$rootScope,utils) {
            ...
            $scope.product = {
                active: true,
                name: 'Abdul Kadar',
                course: 'B.Tech Electronic and Communication Enginnering',
                address: 'No.19, Bajanamadam Street, Ellaipillaichaavady',
                city: 'Pondicherry',
                pincode: '605025',
                contact: '984512365478',
                location: 'Cuddalore',
                prog_languages : 'HTML,CSS,JavaScript & PHP',
                certificate_courses : 'HTML',
                other_skills : 'Typewriting, Hardware & Networking',
                p_firstround : '75',
                p_secondround : '85',
                p_thirdround : '83',
                p_overall : '81',
                ...
                main_img: 'assets/img/ecommerce/placeholder.jpg',
