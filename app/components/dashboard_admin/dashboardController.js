    ...
    .controller('dashboardController', [
            ...
            $scope.dynamicStats = [
                {
                    ...
                    title: 'Users (last 7d)',
                    count: '0',
                    chart_data: "assets\/img\/avatars\/users.png",
                ...
                },
                {
                    ...
                    title: 'Registered',
                    count: '0',
                    chart_data: "assets\/img\/avatars\/signup-icon.png",
                    chart_options: {
                        height: 28,
                        width: 64,
                        fill: "#d1e4f6",
                ...
                },
                {
                    ...
                    count: '0',
                    chart_data: "assets\/img\/avatars\/checklist.png",
                    chart_options: {
                        height: 24,
                        width: 24,
                        fill: ["#8bc34a", "#eee"]
                ...
                },
                {
                    ...
                    count: '1',
                    chart_data: "assets\/img\/avatars\/testapproved.png",
                    chart_options: {
                        height: 28,
                        width: 64,
                        fill: "#efebe9",
        ...
        // countUp update
            $scope.$on('onLastRepeat', function (scope, element, attrs) {
                $scope.dynamicStats[0].count = '110';
                $scope.dynamicStats[1].count = '190';
                $scope.dynamicStats[2].count = '64';
                $scope.dynamicStats[3].count = '12';
